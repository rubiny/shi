...
export default function DashboardNav({
  ...
  const moreTabIds = ['battlepass', 'achievements', 'leaderboard', 'referral', 'army', 'history', 'settings', 'admin', 'stake', 'merch', 'spin', 'games', 'vip', 'fiat', 'antifraud', 'memes', 'guilds', 'events'];
            ...
            <div className="relative" ref={moreMenuRef}>
              ...
              {showMoreMenu && (
                <div className="absolute right-0 top-full mt-2 w-52 bg-zinc-950 border border-white/10 rounded-2xl py-2 shadow-2xl z-50">
                  ...
                  {[
                    { id: "referral", label: "Recruit & Earn", icon: "👥" },
